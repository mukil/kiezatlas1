...
var SERVER_URL = "http://sozialraumdaten.kiezatlas.de/";
...
var kiezatlas = new function() {
    ...
    this.publishedMaps =
        [{
			"id": "t-1230681",
			"name": "\"Ost- und Südosteuropa in Berlin\" -  Anlaufstellen und Unterstützungsangebote für Zugewanderte -",
			"alias": "osoe",
			"workspaceId": "t-1230659"
		}, {
			"id": "t-1199571",
			"name": "Arabisches Leben in Berlin",
			"alias": "atlas-al-arab",
			"workspaceId": "t-1199551"
		}, {
			"id": "t-759304",
			"name": "Charlottenburg-Wilmersdorf Gesamt",
			"alias": "charlottenburg-wilmersdorf-gesamt",
			"workspaceId": "t-202832"
		}, {
			"id": "t-307994",
			"name": "Familienatlas Steglitz-Zehlendorf Gesamt",
			"alias": "familienatlas-sz-gesamt",
			"workspaceId": "t-307976"
		}, {
			"id": "t-239983",
			"name": "Friedrichshain-Kreuzberg-Gesamt",
			"alias": "friedrichshain-kreuzberg-gesamt",
			"workspaceId": "t-239968"
		}, {
			"id": "t-1226999",
			"name": "Info-Portal für Alleinerziehende",
			"alias": "a3ts",
			"workspaceId": "t-1226978"
		}, {
			"id": "t-212394",
			"name": "Lichtenberg Gesamt",
			"alias": "lichtenberg-gesamt",
			"workspaceId": "t-188946"
		}, {
			"id": "t-253504",
			"name": "Mitte Gesamt",
			"alias": "mitte-gesamt",
			"workspaceId": "t-253470"
		}, {
			"id": "t-267237",
			"name": "Nachbarschaft, Engagement, Selbsthilfe",
			"alias": "alle-bezirke",
			"workspaceId": "t-267217"
		}, {
			"id": "t-921086",
			"name": "Pankower Lieblings-Orte",
			"alias": "fuerfastalle",
			"workspaceId": "t-921068"
		}, {
			"id": "t-969885",
			"name": "Rostock",
			"alias": "rostock",
			"workspaceId": "t-969867"
		}, {
			"id": "t-304731",
			"name": "Tempelhof-Schöneberg Gesamt",
			"alias": "tempelhof-schoeneberg-gesamt",
			"workspaceId": "t-3796"
		}, {
			"id": "t-1608274",
			"name": "Weißenseer Lieblings-Orte",
			"alias": "weisenseer-lieblingsorte",
			"workspaceId": "t-1608243"
		}, {
			"id": "t-1760647",
			"name": "Willkommen",
			"alias": "willkommen",
			"workspaceId": "t-1760623"
		}]
    ...
    this.renderMobileCityMapView = function () {
        ...
        kiezatlas.loadCityMapTopics(kiezatlas.cityMapId, kiezatlas.workspaceId, function() {
    ...
    this.loadCityMap = function (mapId, workspaceId) {
        ...
        kiezatlas.loadCityMapTopics(mapId, workspaceId, function () {
            console.log("Rendering City Map Topics", kiezatlas.mapTopics)
    ...
    this.loadCityMapTopics = function (mapId, workspaceId, handler) {
        ...
        jQuery.ajax({
            ...
            success: function(obj) {
                console.log("Map Topics Loaded", obj)
    ...
    this.loadWorkspaceCriterias = function (mapId, handler) {
        var url = SERVICE_URL;
        var body = '{"method": "getWorkspaceCriterias", "params": ["' + mapId + '"]}';
        jQuery.ajax({
    ...
    /** this.loadPublishedMobileCityMaps = function(renderOption) {
        ...
        jQuery.ajax({ type: "POST", url: url, data: body, async: false,
    	    beforeSend: function(xhr) { 
		xhr.setRequestHeader("Content-Type", "application/json")
	    },
            success: function(obj) {
                console.log("found the following mobile city maps", obj)
		var list = JSON.parse(obj)
                console.log(list.result.maps)
