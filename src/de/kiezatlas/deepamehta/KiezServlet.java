...
public class KiezServlet extends JSONRPCServlet implements KiezAtlas {
	...
	/**
	 * search for topic property name and returns a list of slim geo objects
	 * as results
	 *
	 * @param params
	 * @param directives
	...
	/**
	 * creates a list of categorizations for each slim topic checks for each
	 * criteria type if one is directly associated with the category
	 *
	 * @param topicId
	 * @param workspaceId
	 * @return
	...
	/**
	 * returns null if no topictype whihc is assigned to the given
	 * workspace, is a subtype of "GeoObjectTopic"
	 *
	 * @param workspaceId
	 * @return
	 */
